...
urlpatterns = [
    ...
    path('products/offerproducts', views.getOfferProducts.as_view(), name="offerproducts"),
    path('productgallery/<product_id>', views.getProductGallery, name="productgallery"),
    path('products/flashproducts', views.getFlashProducts.as_view(), name="flashproducts"),
